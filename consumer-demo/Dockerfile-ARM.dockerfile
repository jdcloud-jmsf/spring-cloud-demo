...
ENTRYPOINT ["java","-jar","-Dloader.path=config","/export/servers/sc-consumer.jar","--spring.config.location=/export/servers/config/","-javaagent:/export/servers/agent/skywalking-agent.jar"]
